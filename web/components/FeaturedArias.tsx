...
export default function FeaturedArias({
  ...
  return (
    <section
      className="relative mt-6 pt-4 pb-6 px-4 sm:pt-6 sm:px-6 md:mt-12 lg:pt-10 lg:pb-18 lg:px-12"
      aria-labelledby="new-additions-title"
    >
      <div className="text-center">
        <h2
          id="new-additions-title"
          className="tracking-tight font-bold text-gray-800 xs:text-lg sm:text-xl md:text-2xl"
        >
